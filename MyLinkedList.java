...
public class MyLinkedList<T> implements Iterable<T> {
    ...
    private class ListIter implements ListIterator<T>{
        ...
        public int nextIndex() {
            return MyLinkedList.this.indexOf(current.getNext().getValue());
        }

        @Override
        public int previousIndex() {
            return MyLinkedList.this.indexOf(current.getPrev().getValue());
        }
        ...
        public void remove() {
            ...
            MyLinkedList.this.remove(indexOf(current.getValue()));
        }

        @Override
        public void set(T t) {
            MyLinkedList.this.set(indexOf(current.getValue()), t);
        }

        @Override
        public void add(T t) {
            MyLinkedList.this.insert(indexOf(current.getValue()), t);
        }
    }
